...
namespace Api.Application.Controllers
{
    ...
    [ApiController]
    public class ImagensPController : ControllerBase
    {
        public IImagensPService _service { get; set; }
        public ImagensPController(IImagensPService service)
        {
            _service = service;
        }
        ...
        [Authorize("Bearer")]
        [HttpPost]
        public async Task<ActionResult> Post([FromBody] ImagensPDtoCreate dtoCreate)
        {
            if (!ModelState.IsValid)
            {
        ...
        [Authorize("Bearer")]
        [HttpPut]
        public async Task<ActionResult> Put([FromBody] ImagensPDtoUpdate dtoUpdate)
        {
