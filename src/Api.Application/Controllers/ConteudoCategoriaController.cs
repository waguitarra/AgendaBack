...
namespace Api.Application.Controllers
{
    ...
    [ApiController]
    public class ConteudoCategoriaController : ControllerBase
    {
        public IConteudoCategoriaService _service { get; set; }
        public ConteudoCategoriaController(IConteudoCategoriaService service)
        {
            _service = service;
        }
        ...
        [Authorize("Bearer")]
        [HttpPost]
        public async Task<ActionResult> Post([FromBody] ConteudoCategoriaDtoCreate dtoCreate)
        {
            if (!ModelState.IsValid)
            {
            ...
            try
            {
                ...
                {
                    return BadRequest("Conteúdo categoria já cadastrada");
                }
            }
            catch (ArgumentException e)
            {
        ...
        [Authorize("Bearer")]
        [HttpPut]
        public async Task<ActionResult> Put([FromBody] ConteudoCategoriaDtoUpdate dtoUpdate)
        {
